...
Como se puede observar, la media de la tasa de actividad general (sin distinguir por género) es de 62.91743. Además, se observa un desvío estándar -en relación con esta tasa de actividad promedio- de 6.747634.
...
```{r}
max(datos_tp$tasa_actividad) - min(datos_tp$tasa_actividad)
```

La tasa de actividad sin distinción por sexo muestra un rango de 20.3
